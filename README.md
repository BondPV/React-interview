...
В общем, `useMemo` используется для кэширования значений, а `useCallback` - для кэширования функций обратного вызова. Однако, если функция обратного вызова не используется в дочерних компонентах, то useMemo может быть более подходящим выбором.

...
<a id="7"/></a>
`7.Context`  
[7.1. В чем разница между context API and prop drilling?](#7.1)  
[7.2. Когда не следует использовать context API?](#7.2)  
...
`7.Context`
<a id="7.1"></a>
## 7.1. В чем разница между context API and prop drilling?
...
<a id="7.2"></a>
## 7.2. Когда не следует использовать context API?
